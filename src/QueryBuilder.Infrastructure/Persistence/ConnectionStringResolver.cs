...
/// </summary>
public sealed class ConnectionStringResolver(IConfiguration configuration) : IConnectionStringResolver
{
    public string Resolve(DataSource dataSource) =>
        configuration.GetConnectionString(dataSource.ConnectionStringName)
